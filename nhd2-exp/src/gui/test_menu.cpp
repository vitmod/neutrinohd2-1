...
int CTestMenu::exec(CMenuTarget* parent, const std::string &actionKey)
{
	...
	if(actionKey == "vfd") 
	{
		...
		CVFD::getInstance()->ShowText((char *)"Test...");
	...
	{
		ShowMsgUTF(LOCALE_MESSAGEBOX_INFO, "not supported!", CMessageBox::mbrBack, CMessageBox::mbBack, NEUTRINO_ICON_INFO);
	}
...
int CTestMenu::TestMenu()
{
	CMenuWidget * TestMenu = new CMenuWidget("Test Menu");
	TestMenu->addItem( GenericMenuBack );
	TestMenu->addItem( GenericMenuSeparatorLine );
	
	TestMenu->addItem(new CMenuForwarderNonLocalized("VFD", true, NULL, new CTestMenu(), "vfd"));
	TestMenu->addItem(new CMenuForwarderNonLocalized("Network", true, NULL, new CTestMenu(), "network"));
	TestMenu->addItem(new CMenuForwarderNonLocalized("Smartcard", true, NULL, new CTestMenu(), "card"));
	TestMenu->addItem(new CMenuForwarderNonLocalized("HDD", true, NULL, new CTestMenu(), "hdd"));
	TestMenu->addItem(new CMenuForwarderNonLocalized("Buttons", true, NULL, new CTestMenu(), "buttons"));
	TestMenu->addItem(new CMenuForwarderNonLocalized("Scan 12538000", true, NULL, new CTestMenu(), "scan"));
	//TestMenu->addItem(new CMenuForwarderNonLocalized("22 Khz ON", true, NULL, new CTestMenu(), "22kon"));
	//TestMenu->addItem(new CMenuForwarderNonLocalized("22 Khz OFF", true, NULL, new CTestMenu(), "22koff"));
