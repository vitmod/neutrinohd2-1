...
class Font
{
	...
	public:
		...
		void RenderString(int x, int y, const int width, const char * text, const uint8_t color, const int boxheight = 0, const bool utf8_encoded = false);
		void RenderString(int x, int y, const int width, const std::string & text, const uint8_t color, const int boxheight = 0, const bool utf8_encoded = false);
