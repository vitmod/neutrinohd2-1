...
#define PIC_H 39
	...
	if (satellitePosition != 0 && satellitePositions.size() ) 
	{
		...
		g_PicViewer->DisplayLogo(channel_id, PIC_X, PIC_Y, PIC_W, PIC_H);
...
int CInfoViewer::handleMsg(const neutrino_msg_t msg, neutrino_msg_data_t data)
{
	...
	else if (msg == NeutrinoMessages::EVT_ZAP_SUB_FAILED) 
	{
		...
		// show failure..!
#if defined (PLATFORM_CUBEREVO) || defined (PLATFORM_CUBEREVO_MINI) || defined (PLATFORM_CUBEREVO_MINI2) || defined (PLATFORM_CUBEREVO_MINI_FTA) || defined (PLATFORM_CUBEREVO_250HD) || defined (PLATFORM_CUBEREVO_2000HD) || defined (PLATFORM_CUBEREVO_9500HD) || defined (PLATFORM_DUCKBOX) || defined (PLATFORM_SPARK_7162)
