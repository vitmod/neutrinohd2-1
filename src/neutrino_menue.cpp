...
const neutrino_locale_t keymap_head[KEYMAP_COUNT] = 
{
	...
	LOCALE_KEYMAP_KEY_INFO,
	LOCALE_KEYMAP_KEY_EPG,
	LOCALE_KEYMAP_KEY_RECALL,
	LOCALE_KEYMAP_KEY_FAVORITES,
	LOCALE_KEYMAP_KEY_SAT,
	LOCALE_KEYMAP_KEY_RECORD,
	LOCALE_KEYMAP_KEY_PLAY,
	LOCALE_KEYMAP_KEY_PAUSE,
	LOCALE_KEYMAP_KEY_FORWARD,
	LOCALE_KEYMAP_KEY_REWIND,
	LOCALE_KEYMAP_KEY_STOP,
	LOCALE_KEYMAP_KEY_TIMESHIFT,
	LOCALE_KEYMAP_KEY_MODE,
	LOCALE_KEYMAP_KEY_NEXT,
	LOCALE_KEYMAP_KEY_PREV,
	LOCALE_KEYMAP_KEY_MUSIC,
	LOCALE_KEYMAP_KEY_PICTURE,
	LOCALE_KEYMAP_KEY_REPEAT,
	LOCALE_KEYMAP_KEY_SLOW,
	LOCALE_KEYMAP_KEY_DVBSUB,
	LOCALE_KEYMAP_KEY_PIP,
	LOCALE_KEYMAP_KEY_PIPPOS,
	LOCALE_KEYMAP_KEY_PIPSWAP,
	LOCALE_KEYMAP_KEY_PIPSUBCHAN,
	...
	LOCALE_KEYMAP_KEY_VFDLEFT,
	LOCALE_KEYMAP_KEY_VFDPOWER,
	LOCALE_KEYMAP_KEY_VFDMENU,
	LOCALE_KEYMAP_KEY_VFDEXIT,
	LOCALE_KEYMAP_KEY_VFDOK,
};
...
void CNeutrinoApp::InitKeySettings(CMenuWidget &keySettings, CMenuWidget &bindSettings)
{
	...
	neutrino_msg_t * keyvalue_map[KEYMAP_COUNT] =
	{
		...
		&g_RCInput->key_info,
		&g_RCInput->key_epg,
		&g_RCInput->key_recall,
		&g_RCInput->key_favorites,
		&g_RCInput->key_sat,
		&g_RCInput->key_record,
		&g_RCInput->key_play,
		&g_RCInput->key_pause,
		&g_RCInput->key_forward,
		&g_RCInput->key_rewind,
		&g_RCInput->key_stop,
		&g_RCInput->key_timeshift,
		&g_RCInput->key_mode,
		&g_RCInput->key_next,
		&g_RCInput->key_prev,
		&g_RCInput->key_music,
		&g_RCInput->key_picture,
		&g_RCInput->key_repeat,
		&g_RCInput->key_slow,
		&g_RCInput->key_dvbsub,
		&g_RCInput->key_pip,
		&g_RCInput->key_pippos,
		&g_RCInput->key_pipswap,
		&g_RCInput->key_pipsubch,
		&g_RCInput->key_net,
		...
		&g_RCInput->key_vfdleft,
		&g_RCInput->key_vfdpower,
		&g_RCInput->key_vfdmenu,
		&g_RCInput->key_vfdexit,
		&g_RCInput->key_vfdok,
	};
	
	CKeyChooser * keymapchooser[KEYMAP_COUNT];

	for (int i = 0; i < KEYMAP_COUNT; i++)
		keymapchooser[i] = new CKeyChooser((int *)keyvalue_map[i], keymap_head[i], NEUTRINO_ICON_SETTINGS);
