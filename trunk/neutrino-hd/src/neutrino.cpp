...
int CNeutrinoApp::loadSetup(const char * fname)
{
	...
	// themes
	//neutrinohd2 colors default
	g_settings.menu_Head_alpha = configfile.getInt32( "menu_Head_alpha", 0 );
	g_settings.menu_Head_red = configfile.getInt32( "menu_Head_red", 48 );
	g_settings.menu_Head_green = configfile.getInt32( "menu_Head_green", 48 );
	g_settings.menu_Head_blue = configfile.getInt32( "menu_Head_blue", 48 );
	...
	g_settings.menu_Content_Selected_red = configfile.getInt32( "menu_Content_Selected_red", 22 );
	g_settings.menu_Content_Selected_green = configfile.getInt32( "menu_Content_Selected_green", 22 );
	g_settings.menu_Content_Selected_blue = configfile.getInt32( "menu_Content_Selected_blue", 22 );
